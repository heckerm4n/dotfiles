...
public class Professor extends User {
    ...
    public void manageCourses(Scanner scanner, CourseCatalog courseCatalog) {
        while (true) {
            ...
            switch (choice) {
                case 1:
                    viewAssignedCourses(courseCatalog);
                    break;
                case 2:
    ...
    private void viewAssignedCourses(CourseCatalog courseCatalog) {
        List<Course> assignedCourses = courseCatalog.getProfessorAssignments(this.getId());
    ...
    private void updateCourseDetails(Scanner scanner, CourseCatalog courseCatalog) {
        ...
        if (course == null || !course.getAssignedProfessor().equals(this)) {

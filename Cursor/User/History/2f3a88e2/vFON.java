...
public class CourseCatalog {
    ...
    private void initializeCourses() {
        ...
        // Semester 3 courses
        addCourse(new Course("BIO211", "Cell Biology and Biochemistry", 4, 3, "Jaspreet Kaur", null, 70, "09:00-11:00"));
        addCourse(new Course("BIO214", "Genetics and Molecular Biology", 4, 3, "Gaurav Ahuja", null, 70, "11:00-13:00"));
        addCourse(new Course("CSE121", "Discrete Mathematics", 4, 3, "Bapi Chatterjee", null, 70, "14:00-16:00"));
        addCourse(new Course("CSE201", "Advanced Programming", 4, 3, "Arun Balaji Buduru", null, 70, "16:00-18:00"));
        addCourse(new Course("CSE231", "Operating Systems", 4, 3, "Vivek Kumar", null, 70, "09:00-12:00"));
        addCourse(new Course("DES201", "Design Processes and Perspectives", 4, 3, "Anmol Srivastava", null, 70, "13:00-15:00"));
        addCourse(new Course("MTH203", "Math III", 4, 3, "Satish Pandey", null, 70, "15:00-17:00"));
        addCourse(new Course("MTH210", "Discrete Structures", 4, 3, "Ashish Kumar Pandey", null, 70, "09:00-11:00"));
        addCourse(new Course("MTH211", "Number Theory", 4, 3, "Debika Banerjee", null, 70, "11:00-13:00"));
        addCourse(new Course("MTH240", "Real Analysis I", 4, 3, "Nabaneita Ray", null, 70, "14:00-16:00"));
        addCourse(new Course("ECE215", "Circuit Theory and Devices", 4, 3, "Pragya Kosta", null, 70, "16:00-18:00"));
        addCourse(new Course("ECE250", "Signals & Systems", 4, 3, "Anubha Gupta", null, 70, "09:00-11:00"));
        addCourse(new Course("ECE270", "Embedded Logic Design", 4, 3, "Sumit Darak", null, 70, "11:00-13:00"));
        ...
        addCourse(new Course("SOC216", "Political Anthropology: State, Subject, Power", 4, 3, "Deepak Prince", null, 70, "15:00-17:00"));
        addCourse(new Course("SSH221", "Social & Political Philosophy", 4, 3, "Manohar Kumar", null, 70, "09:00-11:00"));

        // Semester 4 courses
        addCourse(new Course("BIO213", "Introduction to Quantitative Biology", 4, 4, "Jaspreet Kaur", null, 70, "09:00-11:00"));
        addCourse(new Course("BIO221", "Practical Bioinformatics", 4, 4, "Tavpritesh Sethi", null, 70, "11:00-13:00"));
        addCourse(new Course("ECE113", "Basic Electronics", 4, 4, "Tammam Tillo", null, 70, "14:00-16:00"));
        addCourse(new Course("CSE202", "Fundamentals of Database Systems", 4, 4, "Mukesh Mohania, Madiha (TF)", null, 70, "16:00-18:00"));
        addCourse(new Course("CSE222", "Analysis and Design of Algorithms", 4, 4, "Diptapriyo Majumdar, Meera (TF)", null, 70, "09:00-12:00"));
        addCourse(new Course("CSE322", "Theory of Computation", 4, 4, "Syamantak Das", null, 70, "13:00-15:00"));
        addCourse(new Course("CSE342/ECE356", "Statistical Machine Learning", 4, 4, "A V Subramanyam", null, 70, "15:00-17:00"));
        addCourse(new Course("DES205", "Design of Interactive Systems", 4, 4, "Kalpana Shankhawar", null, 70, "09:00-11:00"));
        addCourse(new Course("DES206", "Prototyping Interactive Systems", 4, 4, "Richa Gupta", null, 70, "11:00-13:00"));
        addCourse(new Course("ECE214", "Integrated Electronics", 4, 4, "Abhijit Mitra", null, 70, "14:00-16:00"));
        addCourse(new Course("ECE230", "Fields and Waves", 4, 4, "Sayak Bhattacharya", null, 70, "16:00-18:00"));
        addCourse(new Course("ECE240", "Principles of Communication Systems", 4, 4, "Ranjitha P", null, 70, "09:00-11:00"));
        addCourse(new Course("ECE210", "Physics of Semiconductor Devices (New)", 4, 4, "Ram Krishna Ghosh", null, 70, "11:00-13:00"));
        addCourse(new Course("ECE211", "Electronic System Design (New)", 4, 4, "Alok Mittal (G)", null, 70, "14:00-16:00"));
        addCourse(new Course("MTH204", "Maths IV - ODE/PDE", 4, 4, "Ashish Kumar Pandey", null, 70, "16:00-18:00"));
        addCourse(new Course("MTH212", "Abstract Algebra I", 4, 4, "Sneha Chaubey", null, 70, "09:00-12:00"));
        addCourse(new Course("MTH300", "Introduction to Mathematical Logic", 4, 4, "Sankha Basu", null, 70, "13:00-15:00"));
        addCourse(new Course("MTH310", "Graph Theory", 4, 4, "Samaresh Chatterji (V)", null, 70, "15:00-17:00"));
        addCourse(new Course("MTH372", "Statistical Inference", 4, 4, "Anisha Aggarwal (G)", null, 70, "09:00-11:00"));
        addCourse(new Course("MTH374", "Linear Optimization", 4, 4, "Pravesh Biyani", null, 70, "11:00-13:00"));
        addCourse(new Course("MTH377", "Convex Optimization", 4, 4, "Ruhi Sonal", null, 70, "14:00-16:00"));
        addCourse(new Course("ECO221", "Econometrics 1", 4, 4, "JV Meenakshi", null, 70, "16:00-18:00"));
        addCourse(new Course("SOC213", "Introduction to Digital Ethnography", 4, 4, "Soibam Haripriya", null, 70, "09:00-11:00"));
        addCourse(new Course("SSH215", "Nation and Her Narratives", 4, 4, "Payel C Mukherjee (V)", null, 70, "11:00-13:00"));
        addCourse(new Course("SSH325", "Ethics in AI", 4, 4, "Manohar Kumar", null, 70, "14:00-16:00"));
        addCourse(new Course("ENT301", "Foundations of Marketing", 4, 4, "Jyoti Sharma (V)", null, 70, "16:00-18:00"));
        addCourse(new Course("ESC207", "Ecology, Evolution, and Environment", 2, 4, "D. K. Sharma (V)", null, 70, "09:00-11:00"));
    }

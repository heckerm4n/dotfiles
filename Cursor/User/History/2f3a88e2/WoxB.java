...
public class CourseCatalog {
    ...
    private void initializeCourses() {
        ...
        for (Course course : courses.values()) {
            ...
            course.setOfficeHours(generateRandomOfficeHours());
        }
    }

    private String generateRandomSyllabus(String courseCode) {
import java.util.ArrayList;
import java.util.List;
import java.util.HashMap;
import java.util.Map;
...
public class CourseCatalog {
    ...
    public void addProfessor(Professor professor) {
        ...
        // Assign courses to the professor if any
        for (Course course : courses.values()) {
            if (course.getAssignedProfessor().getName().equals(professor.getName())) {
                professor.addAssignedCourse(course);
                course.assignProfessor(professor);
            }
        }
    ...
    public void assignProfessorToCourse(String professorName, String courseCode) {
        Professor professor = professors.get(professorName);
